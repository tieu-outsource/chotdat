...
class MyDropdownDatePicker extends StatefulWidget {
  ...
  MyDropdownDatePicker(
      {Key? key,
        ...
        this.dayFlex = 1,
        this.yearFlex = 2})
      : assert(["en", "zh_CN", "it_IT", "vi_VN"].contains(locale)),
        super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _MyDropdownDatePickerState createState() => _MyDropdownDatePickerState();
}

class _MyDropdownDatePickerState extends State<MyDropdownDatePicker> {
  var monthselVal = '';
  var dayselVal = '';
  var yearselVal = '';
  int daysIn = 32;
  ...
  void initState() {
    ...
    } else if (widget.locale == "vi_VN") {
      listMonths = listMonths_vi_VN;
    } else {
  ...
  // List of months, vi_VN
  List<dynamic> listMonths_vi_VN = [
    {"id": 1, "value": "Tháng một"},
    {"id": 2, "value": "Tháng hai"},
    {"id": 3, "value": "Tháng ba"},
    {"id": 4, "value": "Tháng tư"},
    {"id": 5, "value": "Tháng năm"},
    {"id": 6, "value": "Tháng sáu"},
    {"id": 7, "value": "Tháng bảy"},
    {"id": 8, "value": "Tháng tám"},
    {"id": 9, "value": "Tháng chín"},
    {"id": 10, "value": "Tháng mười"},
    {"id": 11, "value": "Tháng mười một"},
    {"id": 12, "value": "Tháng mười hai"}
  ];
